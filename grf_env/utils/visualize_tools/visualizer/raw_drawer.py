...
class RawDrawer:
    def __init__(self, canvas: tk.Canvas, obs: dict) -> None:
        ...
        self.pitch_height_frame = 360 * 0.8  # int(self.canvas_height*0.98)
        self.pitch_width_frame = 550 * 0.8  # int(self.canvas_width*0.98)
    ...
    def create_pitch(self):
        ...
        path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "radar.png")
