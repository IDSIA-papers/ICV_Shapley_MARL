...
def openrl_obs_deal(obs):
    ...
    # ball owned player 23, one-hot encoding who has the ball
    # if nobody has the ball (outside), then value 1 at last position, 
    # else at respective position, +11 if opponent team has the ball.
    ...
    #ball_info and ball_owned_player are included in ball_own_active_info
