...
from football_env.core import config, football_env
...
def _apply_output_wrappers(
    ...
    if apply_single_agent_wrappers:
        ...
        # removed below, otherwise ERROR because step in GRF retruns only done, 
        # while new gymnasium requires terminated and truncated. 
        # This only affects when exactly one player is controlled by agent.
